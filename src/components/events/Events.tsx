...
import { Alert, Avatar, Card, CardContent, CardHeader, MenuItem, Modal } from "@mui/material";
import {
    Grid,
    TextField,
    Button
        ...
        <>
            ...
            <ThemeProvider theme={theme}>
                <Grid container component="main" flexDirection='row' sx={{ width: "sm", height: "md" }}>
                    ...
                    {/*Right Content*/}
                    <Grid item xs={12} sm={8} md={5} component={Paper} spacing={2} sx={{ background: "none", flexDirection: "column" }}>

                        <Grid item xs={12} sm={8} md={5} component={Paper} elevation={1} sx={useStyles.paper}>
                            <Box
