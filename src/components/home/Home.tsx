      ...
      <Grid container component="main" sx={{ height: "100vh" }}>
        ...
        <Grid item xs={false} sm={4} md={7} sx={{ position: "relative" }}>
          ...
          >
            ...
            />
            <h1 style={{ color: "white", fontSize: "1.2rem", fontWeight: 100, textAlign: "center", lineHeight: "1.7", }}>Entraste al home wacho </h1>
            <Link to="/register">Este es el home brrrrr</Link>
          </div>
        </Grid>
        ...
        <Grid item xs={12} sm={8} md={5} component={Paper} elevation={1} square
          ...
          >
            ...
            <Typography component="h1" variant="h5" sx={{ color: "white" }}>
              ESTE ES EL HOMEEE MI PAPAAAACHO
            </Typography>
            <Box
              component="form"
              noValidate
